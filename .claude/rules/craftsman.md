...
1. Read `.claude/rules/` (Conventions, Domain, etc.) to align with project standards.
2. Follow `.claude/workflows/daily-dev.md` for execution (or `/health-check` if fixing/scanning bugs).
