...
/**
 * Domain service — pure rank arithmetic. No Spring imports (Clean Architecture
 * hard-gate: domain/ must not depend on the framework). Registered as a Spring
 * bean via {@code PlaylistInfrastructureConfig}.
 */
